...
% Companion material. To add the demo video, uncomment the last two
% lines of this block and paste its address in. Note that \url must be
% handed a literal URL: it reads its argument verbatim, so it cannot be
% wrapped in a macro or placed inside a conditional.
\vspace{1.2em}
\begin{center}
\small
...
\par\vspace{0.35em}
\textbf{Video walkthrough} \quad \url{https://youtu.be/az1LtAcZYZo}
\end{center}
