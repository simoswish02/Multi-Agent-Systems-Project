...
the system's semantics, and the agents are, by line count and by conceptual
weight, the \emph{smaller} half of the design. Four environmental
...
Two honest qualifications distinguish this from natural self-organisation. First,
the organisation is \emph{trained into} the system: the attractors of the
collective dynamics were shaped by fifty thousand episodes of gradient descent
against a designer-chosen reward, which is self-organisation at execution time
...
deployment artifact is a fully decentralized policy in the strictest sense. The
...
\emph{Organisational structure}, meaning roles, formations and an explicit
