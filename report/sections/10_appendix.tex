...
Global channels      & $6$                        & Visited, Obstacle, Trajectory, Target, Own\_Position, Broken \\
...
python main.py --mode eval  --checkpoint checkpoints/best.pt [--fault-prob P] [--auto-nav]
...
For completeness, Figures~\ref{fig:app-vision} and~\ref{fig:app-maxsteps}
give the two one-factor sweeps summarized in Table~\ref{tab:generalization}
but not shown in the body: the vision-radius and step-budget axes. The six
panels of each follow the layout of Figures~\ref{fig:sweep-nagents}
and~\ref{fig:sweep-density}.
