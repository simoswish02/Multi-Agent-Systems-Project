...
The observation $o_i^t \in \Omega_i$ delivered to the policy is a
...
role of a hand-crafted belief state
(cf.\ Section~\ref{subsec:bg-marl}): they compress the interaction history
